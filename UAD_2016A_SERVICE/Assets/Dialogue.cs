...
public class Dialogue : MonoBehaviour 
{
    ...
    public string m_szRemaningText = "";
    public string m_szShownText = "";
    ...
    public UILabel m_pTextAreaRef = null;
    ...
    [MultilineAttribute(5)]
    [TextAreaAttribute(1, 5)]
    public string m_szProcessedText = "";
	...
	void Start () {
        //Debug.Log("Length of the processed text is: " + m_szFillText.Length);
        m_pTextSoundEffect = GetComponent<AudioSource>();
        m_pArrowForTextRef.SetActive(false);
        GetNextParagraph();
	}
